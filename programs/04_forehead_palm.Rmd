...
n_cv = 10; thresh_hard = 0; max_p_linear = 0.001; n_cl = 5
...
heat_secom = df_secom %>%
  ...
  geom_vline(xintercept = 5.5, color = "blue", linetype = "dashed") +
  geom_hline(yintercept = 5.5, color = "blue", linetype = "dashed") +
  theme_bw() +
...
pseudo = 0; prv_cut = 0.5; lib_cut = 1000; corr_cut = 0.5
wins_quant = c(0.05, 0.95); method = "pearson"; soft = FALSE; thresh_len = 20
n_cv = 10; thresh_hard = 0; max_p_linear = 0.001; n_cl = 2

set.seed(123)
res_linear1 = secom_linear(pseqs, pseudo, prv_cut, lib_cut, corr_cut, 
                           wins_quant, method, soft, thresh_len, n_cv, 
                           thresh_hard, max_p_linear, n_cl)

R = 1000; max_p_dist = 0.001
set.seed(123)
res_dist1 = secom_dist(pseqs, pseudo, prv_cut, lib_cut, corr_cut, 
                       wins_quant, R, thresh_hard, max_p_dist, n_cl)
...
set.seed(123)
res_linear2 = secom_linear(pseqs, pseudo, prv_cut, lib_cut, corr_cut, 
                           wins_quant, method, soft, thresh_len, n_cv, 
                           thresh_hard, max_p_linear, n_cl)

R = 1000; max_p_dist = 0.001
set.seed(123)
res_dist2 = secom_dist(pseqs, pseudo, prv_cut, lib_cut, corr_cut, 
                       wins_quant, R, thresh_hard, max_p_dist, n_cl)
